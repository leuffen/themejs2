...
Die Eins-zu-eins-Übernahme sämtlicher Vorlagenklassen gilt für Layouts und Includes, insbesondere für `.theme-osman`, auch wenn der Kundenname anders lautet. Sie gilt nicht für Markdown-Dateien: Passe deren Klassen und Layout-Attribute nach der Inhaltsrolle an die vorhandenen ThemeJS2-Komponenten, Varianten und Utilities an, statt sämtliche Klassen aus alten Markdown-Dateien oder aus Vorlagen-Markdown unverändert zu übernehmen. Benenne bestehende Theme-Klassen, zugehörige Selektoren, Theme-Importe oder Theme-Bezeichner nicht kundenbezogen um und lege keine Theme-Kopien pro Kunde an. Der Osman-Bezug in einem technischen Klassennamen ist kein zu ersetzender Kundeninhalt. Texte, Links, Bilder und Kundendaten bleiben von Klassenanpassungen unberührt; die strengere Navbar-Vorgabe bleibt bestehen.

...
title: Theme Unify Services
use_navbar: unify
use_footer: unify
description: "Unify-Services-Demo mit editierbaren Nextstrap-Layouts nach der Unify-Services-Landingpage."
ptags:
  - business
  - services
pid: site
...
![Team planning a digital service](https://static.leanea.de/uni-v3.0-docs/assets/img/950x950/img4.jpg)
![Colleagues shaping the service experience](https://static.leanea.de/uni-v3.0-docs/assets/img/950x950/img5.jpg)
{: .feature-media .dots-end .dots-warning .lg:desktop }

<!-- Nutzt die vorhandene Zweispalten-Baseline für Werkzeugauswahl und editierbares Produktbild. -->
## Fast and easy
{: layout="ntl-2col.style-default.reverse-desktop" .header .text-center section-style="--cols: 6;" }
...
![Responsive service teams](https://static.leanea.de/uni-v3.0-docs/assets/img/580x480/img3.jpg)

### Customizable

![Customizable workflows](https://static.leanea.de/uni-v3.0-docs/assets/img/350x700/img2.jpg)

### 24/7 Support

![Continuous collaboration](https://static.leanea.de/uni-v3.0-docs/assets/img/400x700/img2.jpg)
...
<!-- Verwendet die bestehende Logo-Cloud als robuste Integrationsübersicht statt einer seitenbezogenen Icon-Komponente. -->
## Integrate with your favorite tools
{: layout="ntl-2col.style-logo-cloud" .header }

Have apps your team relies on every day? Bring them together in a few clicks.
{: .header }

- ![Jira](https://static.leanea.de/uni-v3.0-docs/assets/svg/brands/jira-icon.svg) **Jira**
- ![Google](https://static.leanea.de/uni-v3.0-docs/assets/svg/brands/google-icon.svg) **Google**
